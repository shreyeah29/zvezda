...
> = {
  ...
  "the-scarlett-heiress-dress": { colours: ["orange", "red"], garmentType: "gown", houseCollection: "occasion" },
  ...
  "blush-noir-2-piece-set": { colours: ["blush", "black"], garmentType: "set", houseCollection: "statement" },
  "blush-elan": { colours: ["blush", "pink"], garmentType: "gown", houseCollection: "romance" },
  "pearl-tailored-set": { colours: ["ivory"], garmentType: "set", houseCollection: "bespoke" },
  "jardin-elegance-dress": { colours: ["green"], garmentType: "gown", houseCollection: "romance" },
  "verdant-whisper-gown": { colours: ["green"], garmentType: "gown", houseCollection: "romance" },
  ...
  "butterfly-inspired": { colours: ["blue"], garmentType: "set", houseCollection: "occasion" },
  zeenat: { colours: ["champagne"], garmentType: "set", houseCollection: "bespoke" },
